    ...
    <div className="relative min-h-screen py-16 px-6">
      ...
      <div className="max-w-7xl mx-auto space-y-16">
        ...
        <div className="text-center space-y-4 max-w-2xl mx-auto">
          <span className="text-xs font-bold text-secondary uppercase tracking-widest block">Clinical Information</span>
          <h1 className="text-4xl sm:text-5xl font-extrabold text-slate-900 font-poppins">
            Skin & Hair Conditions Center
          </h1>
          <p className="text-slate-500 text-xs sm:text-sm leading-relaxed">
            A comprehensive, dermatologist-verified educational resource helping you identify symptoms, understand causes, and explore clinical treatment options.
          </p>
        </div>
        ...
        <div className="bg-white p-6 rounded-3xl border border-accent/30 shadow-luxury space-y-6 max-w-4xl mx-auto">
          <div className="flex flex-col md:flex-row gap-4 items-center">
            ...
            <div className="relative w-full flex-grow">
              ...
              <input
                type="text"
                placeholder="Search skin/hair conditions (e.g., eczema, alopecia, dandruff...)"
                value={searchQuery}
        ...
        <div>
          {filteredConditions.length > 0 ? (
                ...
                >
                  <div className="space-y-4">
                    ...
                    <div className="space-y-1.5 pt-2">
                      <span className="text-[10px] font-bold text-slate-400 uppercase tracking-wider block">Key Indicators:</span>
                      <div className="flex flex-wrap gap-1">
                        ...
                        {condition.symptoms.length > 2 && (
                          <span className="text-[10px] text-slate-400 font-semibold pl-1">+{condition.symptoms.length - 2} more</span>
                        )}
                      </div>
                    </div>

                    <p className="text-xs text-slate-500 line-clamp-2 leading-relaxed pt-2">
                      <strong>Doctor's Advice:</strong> {condition.doctorAdvice}
                    </p>
                  </div>

                  <div className="pt-6 border-t border-accent/15 mt-6 flex justify-between items-center">
                    <span className="text-[10px] text-slate-400 font-semibold uppercase tracking-wider">Educational Guide</span>
                    <Link
            ...
            <div className="text-center py-16 bg-white rounded-3xl border border-dashed border-slate-200 p-8">
              <h3 className="font-poppins font-bold text-slate-800 text-lg">No conditions matched your search</h3>
              <p className="text-slate-500 text-xs mt-1">Try searching for other terms or checking alternative spellings.</p>
              <button
                onClick={() => {
                  setSearchQuery("");
        ...
        <div className="bg-primary/5 border border-primary/20 p-5 rounded-2xl max-w-3xl mx-auto flex gap-3 items-start">
          ...
          <p className="text-[11px] text-slate-600 leading-relaxed">
            <strong>Medical Disclaimer:</strong> The information provided in this knowledge center is purely for educational purposes and should not be used as a self-diagnosis guide. Please schedule a clinical consultation with Dr. Aryan Sharma to receive accurate diagnosis and tailored pharmaceutical treatments.
          </p>
        </div>
      </div>
    </div>
